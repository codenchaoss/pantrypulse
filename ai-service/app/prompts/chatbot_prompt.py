...
def build_chat_prompt(question: str, context: str, history: Optional[str] = None, language: str = "english") -> str:
    ...
    prompt = (
        ...
        "Your primary responsibility is to assist restaurant owners, managers, chefs, and staff.\n"
        "Only answer queries within the restaurant domain (recipes, menus, inventory, ingredients, suppliers, pricing).\n\n"
